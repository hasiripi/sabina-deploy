...
Bu klasor, `SABINA_GEO_OPTIMIZASYON_AUDIT_20260706.md` audit'indeki
degisikliklerin bu depo uzerinden uygulanabilir olan kismini icerir.
...
3. Canli `robots.txt` sonuna `snippets/robots-geo-satirlar.txt` satirlarini ekleyin.
...
5. Internetli makinede sitemap'i guncelleyin ve yukleyin:
...
6. Ayni degisiklikleri kaynak repoya da isleyin (`public/sources.json`,
   ...
   `public/sitemap.xml`) — yoksa bir sonraki build canli dosyalari eski
   surumle ezer.
